...
impl Default for ZzzMidiDisplay {
    fn default() -> Self {
        Self {
            time_offset: 0.0,
...
pub mod setting_id {
    ...
    use super::ZzzMidiDisplayFullSettings;
    type SID = SettingID<ZzzMidiDisplayFullSettings>;
...
impl Settings for ZzzMidiDisplayFullSettings {
    type Key = TrKey;
