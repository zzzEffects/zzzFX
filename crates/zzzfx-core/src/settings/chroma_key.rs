...
pub mod setting_id {
    ...
    use super::ZzzChromaKeyFullSettings;
    type SID = SettingID<ZzzChromaKeyFullSettings>;
...
impl Settings for ZzzChromaKeyFullSettings {
    type Key = TrKey;
