...
impl Default for ZzzAmbientLight {
    fn default() -> Self {
        Self {
            intensity: 0.5,
            edge_width: 0.1,
...
pub mod setting_id {
    ...
    use super::ZzzAmbientLightFullSettings;
    type SID = SettingID<ZzzAmbientLightFullSettings>;
...
impl Settings for ZzzAmbientLightFullSettings {
    type Key = TrKey;
