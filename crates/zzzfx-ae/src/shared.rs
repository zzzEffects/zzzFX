...
use zzzfx_core::settings::{EnumValue, SettingDescriptor, SettingKind, SettingID, Settings, TrKey};
...
pub fn map_params<T: Settings<Key = TrKey> + 'static>(
    ...
    fn get_defaults<U: zzzfx_core::settings::SettingField + 'static, T: Settings>(
        defaults: &T,
        legacy_defaults: &T,
        ...
        match &descriptor.kind {
            SettingKind::Enumeration { options } => {
                ...
                params.add_customized(
                    ...
                    zzzfx_core::i18n::tr(descriptor.label_key),
                    PopupDef::setup(|p| {
                        p.set_options(&options.iter().map(|o| zzzfx_core::i18n::tr(o.label_key)).collect::<Vec<_>>());
            ...
            SettingKind::Boolean => {
                ...
                params.add_customized(
                    ...
                    CheckBoxDef::setup(|c| {
                        ...
                        c.set_label(zzzfx_core::i18n::tr(descriptor.label_key));
                    }),
                    |p| {
                        p.set_id(descriptor.id.ae_id());
                        p.set_flag(ParamFlag::START_COLLAPSED, true);
                    ...
                    |g| {
                        g.add_customized(
                            ...
                            CheckBoxDef::setup(|c| {
                                c.set_default(default_value);
                                c.set_value(legacy_default_value);
                                c.set_label(zzzfx_core::i18n::tr(TrKey::CommonEnabled));
                            }),
                            |p| {
