...
use crate::shared::{
    ...
    fill_buf_bg, detect_num_components, premultiply_alpha,
...
fn is_native_grouped_name(name: &str) -> bool {
    matches!(name, "position_x" | "position_y" | "font_choice" | "font_name" | "formula")
}
...
pub fn get_plugin() -> *const OfxPlugin {
    let pi = PLUGIN_INFO.get_or_init(|| OfxPlugin {
        ...
        apiVersion: 1,
        pluginIdentifier: c"io.github.zzzEffects:LaTeXDisplay".as_ptr(),
