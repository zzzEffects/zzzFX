...
fn main() {
    if std::env::var_os("CARGO_CFG_WINDOWS").is_some() || std::env::var_os("CARGO_CFG_TARGET_OS").as_deref() == Some(OsStr::new("macos")) {
        ...
        pipl::plugin_build(vec![
            ...
            Property::Name("ZZZ Stroke"),
            Property::Category("ZZZ"),

            #[cfg(target_os = "windows")]
            Property::CodeWin64X86("ZZZStrokeMain"),
            #[cfg(target_os = "macos")]
            Property::CodeMacIntel64("ZZZStrokeMain"),
            #[cfg(target_os = "macos")]
            Property::CodeMacARM64("ZZZStrokeMain"),
            ...
            Property::AE_Effect_Match_Name("zzz-stroke"),
